...
Ciphernode operators run the software that forms the Interfold network’s distributed threshold layer.
Ciphernodes participate in threshold cryptography for Encrypted Execution Environments (E3s),
